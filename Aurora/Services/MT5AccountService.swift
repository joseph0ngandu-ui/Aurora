...
class MT5AccountService {
    ...
    private func buildRequest(url: URL, method: String = "GET", body: Encodable? = nil)
        -> URLRequest
    {
    ...
    func createAccount(
        _ accountData: MT5AccountCreate,
        completion: @escaping (Result<MT5AccountData, Error>) -> Void
    ) {
    ...
    func updateAccount(
        accountId: Int, updateData: MT5AccountUpdate,
        completion: @escaping (Result<MT5AccountData, Error>) -> Void
    ) {
